...
<?php
$fichaTitle = $item['name'] ?? 'Nueva plantilla';
$fichaSubtitle = $item ? ($item['code'] ?? null) : null;
$fichaBackUrl = '/admin/mail-templates';
$fichaMode = 'js';
$fichaTabBase = '';
...
?>
    ...
    <div class="admin-ficha-panel" data-tab-panel="tokens" <?= $tab !== 'tokens' ? 'hidden' : '' ?>>
