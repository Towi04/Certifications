...
<?php
$fichaTitle = $item['title'] ?? 'Nuevo documento';
$fichaSubtitle = $item ? ('v' . ($item['version'] ?? '1.0')) : null;
$fichaBackUrl = '/admin/documents';
$fichaMode = 'js';
$fichaTabBase = '';
...
?>
    ...
    <form method="post" action="/admin/documents/save" enctype="multipart/form-data" class="stack form-grid" id="globalDocForm">
        ...
        <div class="admin-ficha-panel" data-tab-panel="documento" <?= $tab !== 'documento' ? 'hidden' : '' ?>>
            <label>Nombre
        ...
        <div class="admin-ficha-panel" data-tab-panel="alcance" <?= $tab !== 'alcance' ? 'hidden' : '' ?>>
            <label>Proveedor
