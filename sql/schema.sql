...
CREATE TABLE IF NOT EXISTS providers (
  ...
  access_fields_json JSON NULL COMMENT 'Catálogo de slots de acceso (folio, links, archivos)',
...
CREATE TABLE IF NOT EXISTS agreements (
  ...
  sign_deadline_days INT UNSIGNED NOT NULL DEFAULT 15,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS partners (
  ...
  access_restricted TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1=puede entrar, no registrar alumnos',
...
CREATE TABLE IF NOT EXISTS partner_agreement_assignments (
  ...
  signature_status ENUM('pending','submitted','approved','rejected','expired') NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS courses (
  ...
  standalone TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1=no requiere vínculo a certificación',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS certifications (
  ...
  access_fields_json JSON NULL COMMENT 'Slots de acceso activos en esta certificación',
...
CREATE TABLE IF NOT EXISTS certification_cases (
  id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  certification_id BIGINT UNSIGNED NULL,
  course_id BIGINT UNSIGNED NULL COMMENT 'Caso de compra de curso standalone (XOR con certification_id)',
  protocol_id BIGINT UNSIGNED NOT NULL,
  ...
  KEY idx_cases_course (course_id),
  ...
  CONSTRAINT fk_cases_course FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE,
