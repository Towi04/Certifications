...
<p>Instituto DOCEO<br>{{Contacto Doceo}}</p>',
    ...
    public function setCertificationFeaturesJson(int $id, ?string $featuresJson): void
    {
        $this->pdo->prepare('UPDATE certifications SET features_json = ? WHERE id = ?')
            ->execute([$featuresJson, $id]);
    }
